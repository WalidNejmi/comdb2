...
extern int gbl_sc_fence_force_unready;
extern int gbl_sc_fence_test_extra_files;
extern int gbl_sc_commit_flags_advertise;
extern int gbl_mempv_test_pause_before_cache_put;
extern int gbl_mempv_test_paused;
extern int gbl_mempv_test_bump_fence_epoch;
